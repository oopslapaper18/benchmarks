...
public class StatsUtil {
    ...
    public static double covariance(double xVariance, double yVariance,
        ...
        int i = 0;
        while (i < ((double[][]) data).length) {
            covariance += (((double[]) ((double[][]) data)[i])[0] - xVariance) *
                            (((double[]) ((double[][]) data)[i])[1] -
                               yVariance);
            i++;
        }
        return covariance;
    ...
    public static double covariance(double xVariance, double yVariance,
        ...
        while (i < ((double[]) x).length) {
            covariance += (((double[]) x)[i] - xVariance) *
                            (((double[]) y)[i] - yVariance);
            i++;
        }
        return covariance;
    }
     ...
     */
    public static double[] fit(double[][] data, double gradient,
                               double offset) {
        double[] fit = (double[]) (new double[((double[][]) data).length]);
        int i = 0;
        while (i < ((double[][]) data).length) {
            ((double[]) fit)[i] = gradient *
                                    ((double[]) ((double[][]) data)[i])[0] +
                                    offset;
            i++;
        }
        return (double[]) fit;
    ...
    public static double standardError(double[] y, double[] fit) {
        ...
        while (i < ((double[]) y).length) {
            rss += (((double[]) fit)[i] - ((double[]) y)[i]) *
                     (((double[]) fit)[i] - ((double[]) y)[i]);
            i++;
        }
        return rss;
    }
     ...
     */
    public static double[] gaussian(int numberOfSamples, double variance,
                                    double mean) {
